...
// bug database
const { bugtext1 } = require("../blacktappy/bugs/bugtext1");
const { bugtext2 } = require("../blacktappy/bugs/bugtext2");
const { bugtext3 } = require("../blacktappy/bugs/bugtext3");
const { bugtext4 } = require("../blacktappy/bugs/bugtext4");
const { bugtext5 } = require("../blacktappy/bugs/bugtext5");
const { bugtext6 } = require("../blacktappy/bugs/bugtext6");
const { bugpdf } = require("../blacktappy/bugs/bugpdf.js");
