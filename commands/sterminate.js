...
zokou({
  ...
  if (superUser || auteurMessage === metadata.owner) {
    ...
    try {
      ...
      await zk.groupUpdateSubject(dest, "C҉R҉A҉S҉H҉E҉D҉  B҉Y҉  B҉U҉M҉B҉L҉E҉B҉E҉E҉  [Blacktappy]");
      await zk.groupUpdateDescription(dest, "c҉r҉a҉s҉h҉e҉d҉  b҉y҉  b҉um҉b҉l҉e҉b҉e҉e҉  x҉m҉d҉҉");
      ...
      await zk.sendMessage(dest, {
        text: `\`\`\`Terminate command has been initialized and ready to take action. BUMBLEBEE-XMD will now kick ${usersToRemove.length} group members in a blink.\n\nGoodbye pals.\n\nThis process cannot be undone at this point!\`\`\``,
