...
zokou({ nomCom: 'aloo',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*_𝘽𝙪𝙢𝙗𝙡𝙚𝙗𝙚𝙚-𝙓𝙈𝘿 is running...... Love it_*`) 
...
zokou({ nomCom: 'scriptkidies',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`top here to Alone script kiddies group https://whatsapp.com/channel/0029VasHgfG4tRrwjAUyTs10`) 
...
┗━━━━━━━━━━━━━━━
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
❶ || Creator = 𖥘 𝘽𝙪𝙢𝙗𝙡𝙚𝙗𝙚𝙚-𝙓𝙈𝘿 𝙏𝙀𝘾𝙃 𖥘
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
