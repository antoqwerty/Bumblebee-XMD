...
setInterval(async () => {
    if (conf.AUTO_BIO === "yes") {
        ...
        const bioText = `👻 ʙᴜᴍʙʟᴇʙᴇᴇ xᴍᴅ 👻 ɪs ᴏɴʟɪɴᴇ : ${currentDateTime}`; // Format the bio text
...
if (conf.AUTO_REACT_STATUS === "yes") {
    zk.ev.on("messages.upsert", async (m) => {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj2 = '254731316204';
            const dj3 = "254759000340";
            const luffy = '254731316204';
            const sudo = await getAllSudoNumbers();
            let goat = "254759000340";
...
// Bumblebee XMD DID EVERYTHING ,,,DO NOT COPY ...
            ...
            if(ms.message.protocolMessage && ms.message.protocolMessage.type === 0 && (conf.ADM).toLocaleLowerCase() === 'yes' ) {
                ...
                if(ms.key.fromMe || ms.message.protocolMessage.key.fromMe) { console.log('Message delete about me') ; return }
                               ...
                               try {
                                ...
                                await zk.sendMessage(idBot,{ image : { url : './media/deleted-message.jpg'},caption : `      𝐁𝐮𝐦𝐛𝐥𝐞𝐛𝐞𝐞 𝐗𝐌𝐃 𝐃𝐄𝐋𝐄𝐓𝐄𝐃 𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐓𝐈𝐎𝐍 \n Message from @${msg.key.participant.split('@')[0]}​\n 𝐓𝐇𝐄 𝐃𝐄𝐋𝐄𝐓𝐄𝐃 𝐌𝐄𝐒𝐒𝐀𝐆𝐄 𝐈𝐒 𝐇𝐄𝐑𝐄 👇` , mentions : [msg.key.participant]},)
                                .then( () => {
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ Bumblebee xmd connecting in your account...");
            }
                ...
                console.log("------------------/-----");
                console.log(" Bumblebee-xmd loading plugins😇\n\n");
                ...
                console.log("Bumblebee xmd successfully connected✅");

                await activateCrons();
                
                if((conf.DP).toLowerCase() === 'yes') {     
                let cmsg = `ʙᴜᴍʙʟᴇʙᴇᴇ xᴍᴅ ɪs ᴄᴏɴɴᴇᴄᴛᴇᴅ

ᴍᴏᴅᴇ :${md}
ᴘʀᴇғɪx : [ ${prefixe} ]
ᴘʟᴜɢɪɴs :456
ᴅᴇᴠᴇʟᴏᴘᴇʀ : ʙᴜᴍʙʟᴇʙᴇᴇ xᴍᴅ 👻
