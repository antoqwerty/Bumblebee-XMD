...
module.exports = { session: process.env.SESSION_ID || 'bright',
    PREFIXE: process.env.PREFIX || "+",
    GITHUB : process.env.GITHUB|| 'https://github.com/Black-Tappy/Bumblee-Bee',
   ...
   GREET_MSG: process.env.GREET_MSG || "Huskii am unavailable mzee 😂",               
    ...
    CAPTION : process.env.CAPTION || "𝘽𝙪𝙢𝙗𝙡𝙚𝙗𝙚𝙚-𝙓𝙈𝘿-MD",
